...
Cu.import("resource://testpilot/modules/Observers.js");
...
let Notifications = {
  ...
  add: function Notifications_add(notification) {
    ...
    Observers.notify("testpilot:notification:added", notification, null);
  },
  ...
  remove: function Notifications_remove(notification) {
    ...
    if (index != -1) {
      ...
      Observers.notify("testpilot:notification:removed", notification, null);
    }
  },
  ...
  replace: function Notifications_replace(oldNotification, newNotification) {
    ...
    if (index != -1)
      ...
      // XXX Should we notify observers about testpilot:notification:added?
    }

    // XXX Should we notify observers about testpilot:notification:replaced?
  },
