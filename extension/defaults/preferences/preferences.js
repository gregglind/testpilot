...
pref("extensions.testpilot.happyURL", "http://input.stage.mozilla.com/happy?ua=${USER_AGENT}&url=${URL}");
pref("extensions.testpilot.sadURL", "http://input.stage.mozilla.com/sad?ua=${USER_AGENT}&url=${URL}");
