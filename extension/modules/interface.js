...
var TestPilotUIBuilder = {
  ...
  buildFeedbackInterface: function(window) {
    ...
    /* Show and hide Feedback menu items based on version -- if user is on beta channel in the
     * final version, they get the 'rate', 'broken', and 'idea' items.  Otherwise they get 'happy'
     * and 'sad'.*/
    if (this.isBetaChannel() && this.appVersionIsFinal()) {
      ...
      window.document.getElementById("feedback-menu-rate-button").setAttribute("hidden", "true");
